...
def encode(msg, pubkey=Key(exponent=47635965863063575281979425780822037L, modulus=189068567799747665845230407241566417L), verbose=False):
...
def decode(bcipher, privkey=Key(exponent=36641110180198809213844607006668093L, modulus=189068567799747665845230407241566417L), verbose=False):
...
# h = encode(msg, pubkey)
# print('-' * 20), "h"
# print base64.b32encode(h)
# print decode(base64.b32decode(base64.b32encode(h)), privkey)
# print('-' * 20)
# p = decode(h, privkey)
# print('-' * 20)
# print(repr(msg))
